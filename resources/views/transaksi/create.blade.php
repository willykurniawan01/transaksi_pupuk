                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="jumlah" name="jumlah" class="form-control  @error('jumlah') is-invalid @enderror" value="{{ old("jumlah") }}">
                                    @error('jumlah')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="kode_kb" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="SW">
                                        <label class="form-check-label" for="inlineRadio1">SW</label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="kode_kb" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="KB">
